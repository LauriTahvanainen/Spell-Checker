...
public class LevenshteinEtaisyys implements IMuokkausEtaisyyslaskija {
    ...
    /**
     * Laskee kahden merkkijonon välisen (Levenshtein) muokkausetäisyyden
     * käyttämällä dynaamisen ohjelmoinnin algoritmia. Muokkausetäisyydellä
     * tarkoitetaan pienintä sallittujen operaation määrä merkkijonolle X,
     * joilla X:stä saadaan merkkijono Y. Tässä tapauksessa sallittuja
     * operaatioita ovat: Yhden merkkin vaihtaminen toiseen, yhden merkkin
     * poistaminen ja yhden merkin lisääminen.
     *
     * @param mjonoX
     * @param mjonoY
