...
/**
 * Trie tietorakenteen yksi solmu. 
 * Solmussa solmua kuvaava merkki, hajautuslista toisista solmuista joihin solmusta pääsee, sekä boolean arvo sille, onko solmuun päättyvä merkkijono sana.
 */
public class TrieSolmu {
    ...
    /**
     * Hakee parametrina annettavalla merkillä solmun solmulistasta mahdollista lapsisolmua.
     * @param merkki
